...
class r {
  ...
  handleRequest({ request: t, event: e }) {
    ...
    let c = r && r.handler;
    const a = t.method;
    if ((!c && this.i.has(a) && (c = this.i.get(a)), !c)) return;
    let o;
    try {
      o = c.handle({ url: s, request: t, event: e, params: i });
    } catch (t) {
      o = Promise.reject(t);
    }
  ...
  findMatchingRoute({ url: t, sameOrigin: e, request: s, event: n }) {
    ...
    for (const r of i) {
      let i;
      const c = r.match({ url: t, sameOrigin: e, request: s, event: n });
      if (c)
        return (
          (i = c),
...
function o(t, s, r) {
  ...
  if ("string" == typeof t) {
    ...
    c = new n(({ url: t }) => t.href === e.href, s, r);
  } else if (t instanceof RegExp) c = new i(t, s, r);
  else if ("function" == typeof t) c = new n(t, s, r);
  else {
    if (!(t instanceof n))
...
const h = {
  ...
  l = {
    ...
    getGoogleAnalyticsName: (t) => t || u(h.googleAnalytics),
    getPrecacheName: (t) => t || u(h.precache),
    getPrefix: () => h.prefix,
    getRuntimeName: (t) => t || u(h.runtime),
    getSuffix: () => h.suffix,
  };
function f(t) {
  t.then(() => {});
...
const p = (t, e) => e.some((e) => t instanceof e);
let m, y;
const g = new WeakMap(),
  b = new WeakMap(),
  v = new WeakMap(),
...
function k(t) {
  return t !== IDBDatabase.prototype.transaction ||
    ...
    ? (
      ...
      ? function (...e) {
          return t.apply(L(this), e), U(g.get(this));
        }
      : function (...e) {
    ...
    : function (e, ...s) {
        ...
        return v.set(n, e.sort ? e.sort() : [e]), U(n);
      };
}
function q(t) {
...
function U(t) {
  ...
  const e = q(t);
  return e !== t && (R.set(t, e), x.set(e, t)), e;
}
const L = (t) => x.get(t);
...
function I(t, e) {
  ...
  const r = async function (t, ...e) {
    ...
    return (
      n && (c = c.index(e.shift())),
      (await Promise.all([c[s](...e), i && r.done]))[0]
    );
  };
  return N.set(e, r), r;
}
...
class B {
  ...
  l(t) {
    const e = t.createObjectStore(C, { keyPath: "id" });
  ...
  async setTimestamp(t, e) {
    const s = {
      ...
      n = (await this.getDb()).transaction(C, "readwrite", {
        durability: "relaxed",
      });
  ...
  async expireEntries(t, e) {
    ...
    const c = [];
    for (const t of i) await s.delete(C, t.id), c.push(t.url);
    return c;
  }
  m(t) {
    return this.u + "|" + O(t);
    ...
    return (
      this.h ||
        (this.h = await (function (
          ...
          return (
            n &&
              c.addEventListener("upgradeneeded", (t) => {
                n(U(c.result), t.oldVersion, t.newVersion, U(c.transaction), t);
              }),
            s &&
              c.addEventListener("blocked", (t) =>
...
class M {
  ...
  async expireEntries() {
    ...
    const t = this.D ? Date.now() - 1e3 * this.D : 0,
      e = await this.q.expireEntries(t, this.R),
      s = await self.caches.open(this.u);
    for (const t of e) await s.delete(t, this.k);
    (this.g = !1), this.v && ((this.v = !1), f(this.expireEntries()));
  }
  async updateTimestamp(t) {
    await this.q.setTimestamp(t, Date.now());
  }
  async isURLExpired(t) {
    if (this.D) {
      const e = await this.q.getTimestamp(t),
  ...
  async delete() {
    (this.v = !1), await this.q.expireEntries(1 / 0);
  }
}
try {
...
class A {
  constructor(t, e) {
    (this._ = {}),
      ...
      (this.N = [...t.plugins]),
      (this.I = new Map());
    for (const t of this.N) this.I.set(t, {});
  ...
  async cacheMatch(t) {
    ...
    const { cacheName: n, matchOptions: i } = this.U,
      ...
      c = Object.assign(Object.assign({}, i), { cacheName: n });
  ...
  async cachePut(t, s) {
    ...
    if (!s)
      throw new e("cache-put-with-no-response", {
        url:
          ((c = r.url),
          new URL(String(c), location.href).href.replace(
            new RegExp(`^${location.origin}`),
            ""
          )),
      });
    var c;
    const a = await this.C(s);
    if (!a) return !1;
      ...
      f = l
        ? await (async function (t, e, s, n) {
            ...
            const r = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
              c = await t.keys(e, r);
            for (const e of c) if (i === P(e.url, s)) return t.match(e, n);
  ...
  *iterateCallbacks(t) {
  ...
  waitUntil(t) {
    return this.j.push(t), t;
  }
  async doneWaiting() {
    let t;
    for (; (t = this.j.shift()); ) await t;
  }
  destroy() {
    this.L.resolve(null);
  }
...
class K {
  constructor(t = {}) {
    (this.cacheName = l.getRuntimeName(t.cacheName)),
  ...
  handleAll(t) {
    ...
    const e = t.event,
      ...
      r = this.O(i, s, e);
    return [r, this.B(r, i, s, e)];
  }
  async O(t, s, n) {
    let i;
    await t.runCallbacks("handlerWillStart", { event: n, request: s });
    try {
      if (((i = await this.M(s, t)), !i || "error" === i.type))
...
function H(t) {
  ...
  return i.searchParams.set($, s), { cacheKey: i.href, url: r.href };
}
class G {
  constructor() {
    (this.updatedURLs = []),
...
class V {
  constructor({ precacheController: t }) {
    (this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
      const s =
        (null == e ? void 0 : e.cacheKey) || this.T.getCacheKeyForURL(t.url);
...
class X extends K {
  constructor(t = {}) {
    (t.cacheName = l.getPrecacheName(t.cacheName)),
      super(t),
      ...
      });
    {
      ...
      (n = await s.fetch(
        ...
        e &&
          c &&
          "no-cors" !== t.mode &&
          (this.A(), await s.cachePut(t, n.clone()));
    }
    return n;
  }
  async W(t, s) {
...
class Y {
  ...
  addToCacheList(t) {
    ...
    for (const n of t) {
      ...
      if ((this.K.set(i, t), this.F.set(i, r), s.length > 0)) {
...
importScripts(),
  ...
  (st = { ignoreURLParametersMatching: [] }),
  (function (t) {
    Z().precache(t);
  })([
    {
  ...
  self.addEventListener("activate", (t) => {
    ...
    t.waitUntil(et(e).then((t) => {}));
  }),
  o(
    ({ url: t }) => /(lite-list)\.(?:json)$/i.test(t.href),
    new (class extends K {
      constructor(t = {}) {
        super(t),
          this.plugins.some((t) => "cacheWillUpdate" in t) ||
            this.plugins.unshift(T);
      }
      async M(t, s) {
      ...
      plugins: [
        new (class {
          constructor(t = {}) {
            (this.cachedResponseWillBeUsed = async ({
              ...
              const i = this.G(n),
                r = this.V(s);
              f(r.expireEntries());
              const c = r.updateTimestamp(e.url);
              if (t)
                try {
                  t.waitUntil(c);
                } catch (t) {}
          ...
          V(t) {
            if (t === l.getRuntimeName())
              throw new e("expire-custom-caches-only");
            let s = this.X.get(t);
            return s || ((s = new M(t, this.J)), this.X.set(t, s)), s;
          }
          G(t) {
            if (!this.D) return !0;
            const e = this.Y(t);
        ...
        })({ maxEntries: 10, maxAgeSeconds: 300 }),
      ],
    }),
    "GET"
  );
